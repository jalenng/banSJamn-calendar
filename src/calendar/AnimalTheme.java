...
public class AnimalTheme implements ThemeStrategy {
	...
	/**
	 * An inner class that creates the turtles
	 */
	...
	/**
	 * An inner class to create sheep
	 */
	private class Sheep implements Icon {
		...
		public void createSheep(Graphics2D g2, double sheepX) {
			...
			Ellipse2D.Double[] puffs = { puff1, puff2, puff3, puff4, puff5, puff6, puff7, puff8, puff9, puff10, puff11,
					puff12, puff13 };
