...
/**
 * A file importer allows for the user to import recurring
 * events from a user-selected .txt file
 */
class FileImporter {
	...
	public static boolean importFile(CalendarModel model) {
	    ...
	    if (fileChooser.showOpenDialog(null) == JFileChooser.APPROVE_OPTION) {
	    	if (addEvents(fileChooser.getSelectedFile(), model)) {
	    		...
	    		JOptionPane.showMessageDialog(
		    			null, 
		    			"Error importing events from file.", 
		    			"Import File", 
	 ...
	 * @return	true if file was successfully parsed and events were imported,
	 * 			false otherwise
	 */
